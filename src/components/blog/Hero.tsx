      ...
      <div className={styles.container}>
        ...
        <div className={styles.postAuthor}>
          ...
          <div className={styles.authorDetails}>
            <strong className={styles.authorName}>Zaid Mukaddam</strong>
            <div className={styles.socials}>
              <a
                ...
                rel="noreferrer"
              >
                <VisuallyHidden>zaidmukaddam&apos;s Twitter</VisuallyHidden>
                <TwitterLogo />
              </a>
              <a
                className="github"
                ...
                rel="noreferrer"
              >
                <VisuallyHidden>zaidmukaddam&apos;s GitHub</VisuallyHidden>
                <GitHubLogo />
              </a>
            </div>
          </div>
