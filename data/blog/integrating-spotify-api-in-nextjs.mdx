...
It seems that the goal of this article has been achieved, I will write about the React component at a later time. If anyone is curious, I open the source of this website in [my github repository](https://github.com/bwyx/boringstonks.live).
